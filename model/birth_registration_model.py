...
class ChildModel(Base):
    ...
    child_nepali_first_name=Column(String(100),default=None)
    child_nepali_middle_name=Column(String(100),default=None)
    child_nepali_last_name=Column(String(100),default=None)
    child_gender          = Column(SAEnum(GenderType), nullable=False)
    child_dob_bs          = Column(DateTime, nullable=False)
    child_dob_ad          = Column(DateTime, nullable=False,default=None)
...
class ParentModel(Base):
    ...
    parent_nepali_first_name=Column(String(100),default=None)
    parent_nepali_middle_name=Column(String(100),default=None)
    parent_nepali_last_name=Column(String(100),default=None)
...
class NomineeModel(Base):
    ...
    nominee_nepali_first_name=Column(String(100),default=None)
    nominee_nepali_middle_name=Column(String(100),default=None)
    nominee_nepali_last_name=Column(String(100),default=None)
